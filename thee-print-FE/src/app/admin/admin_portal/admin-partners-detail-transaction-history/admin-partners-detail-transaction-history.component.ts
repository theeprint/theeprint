...
@Component({
  selector: 'app-admin-partners-detail-transaction-history',
  templateUrl: './admin-partners-detail-transaction-history.component.html',
  styleUrls: ['./admin-partners-detail-transaction-history.component.scss']
})
export class AdminPartnersDetailTransactionHistoryComponent implements OnInit {
    ...
    this.job_order_list = [
      {
        ...
        "job_order_due_date":"03/26/2020",
        "job_order_status":2,
        "job_order_payment_status":0,
        "job_order_total_amount":1000,
        "job_order_remarks":"Romel Postrano"
      },
    ];
