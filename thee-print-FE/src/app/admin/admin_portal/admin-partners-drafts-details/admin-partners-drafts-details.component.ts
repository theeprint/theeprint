...
@Component({
  selector: 'app-admin-partners-drafts-details',
  templateUrl: './admin-partners-drafts-details.component.html',
  styleUrls: ['./admin-partners-drafts-details.component.scss']
})
export class AdminPartnersDraftsDetailsComponent implements OnInit {
