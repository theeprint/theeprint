...
@Component({
  selector: 'app-admin-job-order-list-archive',
  templateUrl: './admin-job-order-list-archive.component.html',
  styleUrls: ['./admin-job-order-list-archive.component.scss']
})
export class AdminJobOrderListArchiveComponent implements OnInit {
