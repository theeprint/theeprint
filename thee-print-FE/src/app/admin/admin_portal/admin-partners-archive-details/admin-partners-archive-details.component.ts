...
@Component({
  selector: 'app-admin-partners-archive-details',
  templateUrl: './admin-partners-archive-details.component.html',
  styleUrls: ['./admin-partners-archive-details.component.scss']
})
export class AdminPartnersArchiveDetailsComponent implements OnInit {
