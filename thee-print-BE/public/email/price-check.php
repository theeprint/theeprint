...
foreach ($row as $rows){
	...
	$to=$rows['user_email'];
	$subject = "You have 1 new price check";
	$message = "
	<html>
		<div style='width:100%;padding:15px;box-sizing:border-box;min-width:320px;background:#f2f2f2; text-align: center'>
			<div style='min-width:450px!important;max-width:600px!important;margin-top:45px;margin-left:auto;margin-right:auto;min-height:150px;background:#ffffff;border-radius:5px!important'>
				...
				<div style='color: #000; padding: 40px 30px;font-family: arial;font-size: 14px;line-height: 1.3em; padding-top: 0px'>
					<h2>You have a 1 new price check!</h2>
					<p>from ".$partner_name."</p>
					<br>
	        		<a href='http://theeprint.com.ph/admin/price-checks-details/".$job_order_request_id."' style='color: #fff;background-color: #C0024A; text-decoration: none; padding: 15px 32px;border-radius: 5px;border: 1px solid transparent;width: 100%;font-weight: 700'>View Price Check</a>
				</div>	
			</div>
